...
export function LegalGenerator() {
  ...
  const isModule2Complete =
    modules.find((m) => m.id === 2)?.status === "completed";
  ...
  const [documents, setDocuments] = useState<CourtDocument[]>(
    isProbate
      ? [
          {
            id: "probate-app",
            name: "Probate Application Form",
            description: "Main application for Grant of Probate",
            status: "drafting",
          },
          {
            id: "will-copy",
            name: "Certified Will Copy",
            description: "Verified copy of the original Will",
            status: "drafting",
          },
          {
            id: "schedule-assets",
            name: "Schedule of Assets",
            description: "Complete list of estate assets and values",
            status: "drafting",
          },
          {
            id: "death-cert",
            name: "Death Certificate",
            description: "Official death certificate copy",
            status: "drafting",
          },
        ]
      : [
          {
            ...
            description: "Application to be appointed Administrator",
            status: "drafting",
          },
          {
            id: "renunciation",
            name: "Renunciation Forms",
            description: "Consent from other eligible family members",
            status: "drafting",
          },
          {
            id: "schedule-assets",
  ...
  const handleDownloadBundle = () => {
    setDocuments((prev) =>
      prev.map((doc) => ({ ...doc, status: "downloaded" as const })),
    );
      ...
      <div className="space-y-6 animate-fade-in">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            {isProbate ? "Grant of Probate" : "Letters of Administration"} —
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Please complete Asset Discovery (Module 2) first. The Schedule
                  of Assets will be auto-populated with the discovered bank
                  accounts and asset values.
                </p>
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          {isProbate ? "Grant of Probate" : "Letters of Administration"} — Court
          Document Generator
        </p>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <Badge variant="outline" className="mb-1">
                {isProbate
                  ? "Grant of Probate Path"
                  : "Letters of Administration Path"}
              </Badge>
              <p className="text-sm text-muted-foreground">
                TurboTax for Court Forms — Review pre-filled documents before
                submission
              </p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Required documents for your {isProbate ? "Probate" : "LOA"}{" "}
                application
              </CardDescription>
            </CardHeader>
          ...
          <Card className="bg-accent/30 border-accent">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-medium text-foreground">
                    Print the Generated Bundle
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">
                    Print <strong>2 copies</strong> of the complete court bundle
                    on A4 paper.
                  </p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-medium text-foreground">
                    Visit CrimsonLogic Service Bureau
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">
                    Submit your documents for e-filing at the service bureau.
                  </p>
                  <p className="text-sm text-muted-foreground mt-1">
                    You will need to book an appointment first.
                  </p>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-3">
                * Actual fees may vary. Check the court website for current
                rates.
              </p>
            </CardContent>
          </Card>
